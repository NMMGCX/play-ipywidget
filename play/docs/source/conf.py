...
# -*- coding: utf-8 -*-
#
# play documentation build configuration file
#
...
_version_py = os.path.join(repo, 'play', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'play.tex', 'play Documentation',
     'cxgu', 'manual'),
]
